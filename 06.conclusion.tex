...
% Overall, \mfog and the idea of using distributed flow classification and novelty detection using small devices at the edge of the network is a viable and promising solution. 
% Further work include the investigation of using varying load balancing strategies and also considering using a distributed version of the k-means clustering.
