...
In this work, we investigate the use of the novelty detection techniques and strategies presented 
...
(ii) the novelty detection phase, which provides the model evolution, must also occur in parallel, at different spots;
...
\begin{figure}[htb]
  \centerline{
    ...
    \includegraphics[width=0.7\linewidth,page=1]{figures/lifecycle.uml.svg.pdf}
