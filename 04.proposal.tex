...
MPI 4.0.4}).
The program is organized in an single program multiple data (SPMD)
...
as leafs, the program entry point is illustrated on Algorithm \ref{alg:MFOG}.
...
classification results and for processing the unknown samples in search for
novelties.
...
cores) classifier threads and the leaf tasks are illustrated in Algorithm
\ref{alg:MFOG-leaf}.
% >>>>>>> dd70e6dd2f93dbb63f7f84ee937aafc4b6ff9684
