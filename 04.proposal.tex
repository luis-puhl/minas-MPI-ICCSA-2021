...
\todo[inline]{Relembrar ids-iot, fase offline e online}
...
\begin{figure}[h]
  \centerline{
    ...
    %   \includegraphics[width=0.9\linewidth,page=1]{figures/mfog-arch-fisica.svg.pdf}
      \includegraphics[width=0.9\linewidth,page=1]{figures/cassalesimgs-000.png}
      \caption{Physical architecture and deployment scenario overview.}
