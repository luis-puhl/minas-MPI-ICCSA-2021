...
% the overall system.
Fog computing infrastructure aims to offload computing resources from cloud
...
In our proposal, fog and cloud computing resources are employed as to minimize
the time elapsed between a flow descriptor ingestion and intrusion alarm,
allocating the classification step of \minas in a MPI cluster running multiple
...
three main functional modules being Classification and Novelty
...
however our implementation only used K-means.
