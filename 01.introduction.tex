...
various types.
Such devices can either be accessed by users through the Internet or %to 
connect
...
Security and privacy is a major concern in the IoT, specially regarding %as 
devices like smart home assistants and wearable devices %hold 
...
software patches, and the ever growing %increase of the 
...
security techniques may not fit %can not be applied 
\cite{Zhou2017}.
...
Despite the promising use of ML to secure IoT systems, %most 
studies presented in the literature %(e.g., those surveyed in
...
% \footnote{\color{red}citation needed}
