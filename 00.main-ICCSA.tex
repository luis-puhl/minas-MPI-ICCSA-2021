...
\usepackage[noalgohanging,opthanginginout,lined,noend]{algorithm2e}
...
\input{01.abstract}
\input{01.introduction}\FloatBarrier
\input{02.related}\FloatBarrier
\input{03.minas}\FloatBarrier
\input{04.proposal}\FloatBarrier
\input{05.experiments}\FloatBarrier
\input{06.conclusion}
