...
During its online phase, which is the main focus of our work, the model performs three tasks in (near) real-time,
...
Long unseen samples are considered to be outliers and eventually removed from the unknowns-buffer, as they correspond to obsolete and nonrepresentative clusters in the current data stream.
...
%clusters that became obsolete and unrepresentative of the current data stream distribution 
\cite{Faria2015minas}.
