...
%   break to 2-3 lines
  ...
  increases, requiring more from network administrators and the need for strategies
...
%   apresentar a estratégia,
  ...
  original, serial and distributed executions while using less time than previous
