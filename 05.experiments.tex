...
There are two broad evaluation metrics for each experiment: a time mesure
...
\begin{figure}
  \centering
  % \includegraphics[width=\linewidth]{experiments/speedup-clean.png}
  \includegraphics[width=\whencolumns{0.65}{1.05}\linewidth,page=1]{experiments/speedup-clean.pdf}
  \caption{Time measurements per added instance}
  \label{fig:speedup}
\end{figure}
